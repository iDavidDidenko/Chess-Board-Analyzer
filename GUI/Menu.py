class Menu:
    ...
    def __init__(self, GUImanager, main_window, tk):
        ...
        self.analiyze_btn = self.tk.Frame(self.menu_frame, width=100, height=50, bg="green")
        ...
        self.black_btn = self.tk.Frame(self.menu_frame, width=100, height=50, bg="black")
        self.black_btn.grid(row=2, column=0, padx=0, pady=0)

        self.white_btn = self.tk.Frame(self.menu_frame, width=100, height=50, bg="white")
    ...
    def __createMenu(self):
        ...
        self.btn_reset = self.tk.Button(self.reset_btn, text="Reset", width=10, height=2, bg="white")
        self.btn_reset.grid(row=1, column=0, padx=0, pady=0)
        self.btn_reset.bind("<Button-1>", lambda event: self.__handle_on_click_reset())

        self.black_btn = self.tk.Button(self.menu_frame, text="Black", width=10, height=2, bg="white")
        self.black_btn.grid(row=2, column=0, padx=0, pady=0)
        self.black_btn.bind("<Button-1>", lambda event: self.__handle_on_click_black())

        self.white_btn = self.tk.Button(self.menu_frame, text="White", width=10, height=2, bg="white")
        self.white_btn.grid(row=3, column=0, padx=0, pady=0)
